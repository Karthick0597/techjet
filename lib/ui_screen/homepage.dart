...
class HomePage extends StatelessWidget {
  ...
  final List<MyImage> imageList = [
    MyImage(
      imagePath: "asset/image/Frame 8.png",
      name: "Pizza",
    ),
    MyImage(
      imagePath: "asset/image/Frame 8 (1).png",
      name: "Burger",
    ),
    MyImage(
      imagePath: "asset/image/Frame 8 (1).png",
      ...
      child: Scaffold(
        bottomNavigationBar: BottomNavigationBar(items: const [
          BottomNavigationBarItem(
            icon: Icon(Icons.home_outlined,color: Color(0xffFA6A02)),
            label: 'Home',
          ),
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("asset/image/Frame 7.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                  child: SizedBox(
